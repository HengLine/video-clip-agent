...
class FFmpegService:
    """V0.1 wrapper — delegates to penclip.utils.ffmpeg_* modules for actual execution."""
    ...
    def cut_segment(self, input_path: str, start: float, end: float, output_path: str) -> bool:
        ...
        from penclip.utils.ffmpeg_run_utils import run_ffmpeg_command
    ...
    def concat_clips(self, clip_paths: List[str], output_path: str, transition: Optional[str] = None) -> bool:
        from penclip.utils.ffmpeg_utils import build_concat_command
        from penclip.utils.ffmpeg_run_utils import run_ffmpeg_command
    ...
    def get_metadata(self, video_path: str) -> Dict[str, Any]:
        from penclip.utils.ffmpeg_run_utils import get_video_metadata
