...
# 导入自定义的控制台颜色处理模块
from penclip.utils.console_colors import init_console_colors, IS_WINDOWS, HAS_COLORAMA, LevelOnlyColoredFormatter
from penclip.utils.log_utils import _generate_dated_filename
from penclip.utils.path_utils import PathResolver
...
class DailyRotatingFileHandler(logging.Handler):
    ...
    def __init__(self, log_dir: str, name: str = 'penclip', max_bytes: int = 10 * 1024 * 1024,
...
class Logger:
    ...
    def __init__(self, name: str = 'penclip', log_dir: Optional[str] = None):
        """
        初始化日志器
