...
from penclip.logger import debug, info, warning
from penclip.state.models import TaskLifecycleStage


# ============================================================================
# 状态映射 — neotask 状态 → PenClip 状态/阶段
# ============================================================================
...
class TaskLifecycleManager:
    ...
    def __init__(
        ...
        from penclip.hub.hub_core import get_hub  # 延迟导入，避免循环依赖
