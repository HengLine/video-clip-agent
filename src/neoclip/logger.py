...
# 导入自定义的控制台颜色处理模块
from neoclip.utils.console_colors import init_console_colors, IS_WINDOWS, HAS_COLORAMA, LevelOnlyColoredFormatter
from neoclip.utils.log_utils import _generate_dated_filename
...
class DailyRotatingFileHandler(logging.Handler):
    ...
    def __init__(self, log_dir: str, name: str = 'neoclip', max_bytes: int = 10 * 1024 * 1024,
...
class Logger:
    ...
    def __init__(self, name: str = 'neoclip', log_dir: Optional[str] = None):
        """
        初始化日志器
